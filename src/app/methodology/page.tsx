...
const DESCRIPTION = 'How opentools researches format guidance, tests browser tools, cites sources, and reviews time-sensitive information.';

export const metadata: Metadata = {
  title: 'Editorial and testing methodology',
  description: DESCRIPTION,
  alternates: { canonical: '/methodology' },
  openGraph: { url: '/methodology', title: 'Editorial and testing methodology · opentools', description: DESCRIPTION, images: [DEFAULT_OG_IMAGE] },
  twitter: { card: 'summary_large_image', title: 'Editorial and testing methodology · opentools', description: DESCRIPTION, images: [DEFAULT_TWITTER_IMAGE] },
};

export default function MethodologyPage() {
  return (
    <>
      <WebPageJsonLd path="/methodology" name="Editorial and testing methodology" description={DESCRIPTION} />
      <ContentShell
        eyebrow="Methodology"
