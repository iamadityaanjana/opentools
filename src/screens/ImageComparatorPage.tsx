    ...
    <div className="page page--tool">
      ...
      <div className="tool-hero">
        ...
        <div>
          ...
          <p className="tool-desc">Compare two images with a before/after slider, an onion-skin blend, and a pixel-difference heatmap using local browser processing.</p>
        </div>
