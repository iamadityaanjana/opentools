    ...
    <div className="page page--tool">
      ...
      <div className="tool-hero">
        ...
        <div>
          ...
          <p className="tool-desc">Pull the still image and any frame from Apple Live Photos (HEIC/JPG + .MOV) or Google/Samsung motion photos with local browser processing.</p>
        </div>
